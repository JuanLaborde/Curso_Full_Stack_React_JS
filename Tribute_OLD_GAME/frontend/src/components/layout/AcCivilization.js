    ...
    return (
        <div className="History-1st-civilization">
            <div className="Text-Format-1st-civilization">
                <img className="Image-metatron" src="ImagesVideos/images/ACImages/Sword.png" alt="" />
                <p className="text-from-left1">The origins of the First Civilization are unclear. 
                They were responsible for the creation of Homo Sapiens, forming the species in their own image to be a capable, but docile workforce. 
                The Precursors also created Homo Neanderthalensis, designing the species to be their expeditionary or military force.</p>
                <br />
                ...
                <br />
                <img className="Halo-of-Sun" src="ImagesVideos/images/ACImages/Apple.png" alt="" />
                ...
                <br />
                <p className="text-from-right">However, before she could use the device, she discovered that Juno had tampered with it somehow, so that it would set her free upon activation. 
                Refusing to unleash Juno from her prison, Minerva destroyed the device, thus condemning the world to face the solar flare, which flipped the Earth's weakening magnetic field, reversing the polarity and making the planet geologically unstable.</p>
                <br />
                ...
                <br />
                <img className="Image-cult" src="ImagesVideos/images/ACImages/Message.jpg" alt="" />
